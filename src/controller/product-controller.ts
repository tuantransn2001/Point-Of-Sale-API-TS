      ...
      if (isAllowToCreate) {
        ...
        const {
          ...
          (res: any, p_variant_properties: Array<any> | string) => {
            ...
            let product_special_variant_name: string = productRow.product_name;
        ...
        await ProductVariantDetail.bulkCreate(productVariantDetailRowArr);
        await ProductVariantPrice.bulkCreate(productVariantPriceRowArr);
        await ProductVariantProperty.bulkCreate(productVariantPropertyArr);
